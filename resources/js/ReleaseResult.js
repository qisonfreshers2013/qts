		...
		if(success){
			if(roles.contains(1)){
				...
				$.each(data,function(key1,value1){
					...
					$('table').append("<tr style='text-align:center'><td>"+name+"</td><td>"+projectName+"</td><td><img class='delete' id="+id+" src='resources/img/delete.png' style='width:100%;cursor:pointer'/></td></tr>");
				});
